...
struct Lexeme
{
    ...
    string value_char = "";
    Vector value_vector;
    int int_or_char = -1; // имя переменной-0, если цифра-1, если вектор -2 

};


void See_number(int number = 0, string Lex_ = "", int value_int = 0, Vector vec = 0)
{
    if (number == 1)
    ...
    if (number == 31)
        cout << left << setw(10) << "C2 " << right << setw(3) << "|" << vec; // Вектор
    if (number == 32)
    ...
    if (number == 36)
        cout << left << setw(10) << "*Комментарий* " << right << setw(3) << "|";
    if (number == 37)
        cout << left << setw(10) << "int " << right << setw(3) << "|";
    if (number == 38)
        cout << left << setw(10) << "vector " << right << setw(3) << "|";
    if (number == 39)
        cout << left << setw(10) << "L " << right << setw(3) << "|" << Lex_; //переход к метке
    if (number == 40)
        cout << left << setw(10) << "do " << right << setw(3) << "|";
    if (number == 41)
        cout << left << setw(10) << "V " << right << setw(3) << "|" << Lex_;//Переменная
    if (number == 42)
        cout << left << setw(10) << "Ошибка " << right << setw(3) << "|";
    if (number == 43)
        cout << left << setw(10) << "( " << right << setw(3) << "|";
    if (number == 44)
        cout << left << setw(10) << ") " << right << setw(3) << "|";
    if (number == 45)
        cout << left << setw(10) << "C " << right << setw(3) << "|" << value_int; // константа
    if (number == 46)
        cout << left << setw(10) << "L: " << right << setw(3) << "|"<< Lex_; // сама метка
    if (number == 47)
...
void Print_Table_Lexem(Lexeme* Table, int size_)
{
    ...
    for (int i = 0; i < size_;)
    {
        while (Table[i].number_line == j && i < size_)
        {
            cout << j;
            cout << "|";
            See_number(Table[i].Word, Table[i].value_char, Table[i].value_int, Table[i].value_vector);
            cout << "\n";
            i++;
        }
        j++;
    ...
    while (!stop)
    {
        ...
        case A1:
            ...
            case Symbol:
                ...
                if (state != Sy_B1)
                {
                    if (Table_Of_Lexemes[Value_Word_Lexems - 1].Word == 32)
                    {
                        state = Sy_L1;
                        zn = 39;
                    }
        ...
        case Ar_D2:
            ...
            case Space:
                Table_Of_Lexemes[Value_Word_Lexems].Word = 31;
                Table_Of_Lexemes[Value_Word_Lexems].value_vector.Vector_by_arr(arr_vect, size_arr_vect + 1);
